...
class LiveStockItems extends StatelessWidget {
  const LiveStockItems({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Livestock Items'),
      ),
      body: SafeArea(
        child: Obx(() {
          return ListView.builder(
              itemCount: controller.cattleProducts.length,
              itemBuilder: (BuildContext context, int index) {
                var product = controller.cattleProducts[index];
